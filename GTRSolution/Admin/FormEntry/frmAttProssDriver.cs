...
{
    public partial class frmAttProssDriver : Form
    {
        ...
        public frmAttProssDriver(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
             ...
             
                {
                   ...
                   if (chkMonthly.Checked == true)
                   {
                       ...
                       while (X <= Y)
                       {
                           ...
                           {
                               sqlQuery = "Exec prcProcessAttendDriver " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtFromDate.Value.ToString()) + "'";
        ...
        private void frmAttProssDriver_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void frmAttProssDriver_FormClosing(object sender, FormClosingEventArgs e)
        {
