...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmGrade : Form
    {
        ...
        public frmGrade(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        public void prcLoadList()
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetGrade  '" + this.Tag.ToString() + "'";
        ...
        public void prcDisplayDetails(string strParam)
        {
         ...
         private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
         {
             ...
             gridList.DisplayLayout.Bands[0].Columns["Amount"].Width = 90;
                ...
                for (rowCount = 0; rowCount < dsList.Tables["Varible"].Rows.Count; rowCount++)
                {
                        ...
                        dsList.Tables["Varible"].Rows[rowCount]["Flag"].ToString() == "1")
                    {
                        ...
                        sqlQuery = "Update tblCat_Variable Set varName = '" + dsList.Tables["Varible"].Rows[rowCount][1] +
                                   ...
                                   dsList.Tables["Varible"].Rows[rowCount][5] + "', Remarks = '" +
                                   dsList.Tables["Varible"].Rows[rowCount][6] + "' where VarId = '" +
                    ...
                    {
                        // Insert To Table
                        sqlQuery = "Insert into tblCat_Variable(varName, varType, Amount, aId, isInactive, Remarks) values('" +
                                   ...
                                   dsList.Tables["Varible"].Rows[rowCount][6] + "')";
                        arQuery.Add(sqlQuery);
        ...
        private void gridList_AfterCellUpdate(object sender, CellEventArgs e)
         {
             gridList.ActiveRow.Cells[7].Value = 1;
