...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmCorporate : Form
    {
        ...
        public frmCorporate(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmCorporate_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //Update     
                    sqlQuery = " Update tblCat_Corporate  Set CPName ='" + txtName.Text.ToString() + "'";
                    sqlQuery += " Where CPId = " + Int32.Parse(txtId.Text);
                ...
                {
                    sqlQuery = "Select Isnull(Max(CPId),0)+1 As NewId from tblCat_Corporate ";
                    NewId = clsCon.GTRCountingData(sqlQuery);
                    //Insert to Table
                    sqlQuery = "Insert Into tblCat_Corporate(CPId,ComId,CPName, PCName, LUserId) ";
                    sqlQuery = sqlQuery + " Values (" + NewId + ", '" + Common.Classes.clsMain.intComId + "','" + txtName.Text.ToString() + "','" + Common.Classes.clsMain.strComputerName + "','" + Common.Classes.clsMain.intUserId + "' )";
        ...
        {
            if (
                MessageBox.Show("Do you want to delete Corporate information of [" + txtName.Text + "]", "",
            ...
            try
            {
                ...
                //Delete Data
                sqlQuery = "Delete from tblCat_Corporate  Where CPId  = " + Int32.Parse(txtId.Text);
                arQuery.Add(sqlQuery);
        ...
        private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            //Set Width
            gridList.DisplayLayout.Bands[0].Columns["CPName"].Width = 395;
