...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmBand : Form
    {
        ...
        public frmBand(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmBand_FormClosing(object sender, FormClosingEventArgs e)
        {
