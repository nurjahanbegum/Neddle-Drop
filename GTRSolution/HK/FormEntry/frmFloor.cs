...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmFloor : Form
    {
        ...
        public frmFloor(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmFloor_FormClosing(object sender, FormClosingEventArgs e)
        {
