...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmReligion : Form
    {
        ...
        public frmReligion(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmReligion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void gridList_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            ...
            gridList.DisplayLayout.Bands[0].Columns["aId"].Style = ColumnStyle.IntegerWithSpin;
