...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmSection : Form
    {
        ...
        public frmSection(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        public void prcLoadList()
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetSection '" + Common.Classes.clsMain.intComId + "',0";
                clsCon.GTRFillDatasetWithSQLCommand( ref dsList, SqlQuery );
                dsList.Tables[0].TableName = "Section";
                //dsList.Tables[1].TableName = "Dept";
                
                gridList.DataSource = null;
                gridList.DataSource = dsList.Tables["Section"];
            }
            catch (Exception ex)
            {
                throw(ex);
        ...
        public void prcLoadCombo()
        {
            ...
            //cboDept.DataSource = dsList.Tables["Dept"];
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //Update     
                    sqlQuery = " Update tblCat_section  Set SectName ='" + txtName.Text.ToString() + "', SectNameB='" + txtNameB.Text.ToString() + "' , SLNO= '" + txtSlNo.Text.ToString() + "' ";
                    ...
                    //sqlQuery = " Update S Set S.DeptName = D.DeptName from tblCat_Section S,tblCat_Department D Where S.DeptId = D.DeptId and S.SectID = " + Int32.Parse(txtId.Text) + "";
                    //arQuery.Add(sqlQuery);
                ...
                else
                {
                    ...
                    //Insert to Table
                    sqlQuery = "Insert Into tblCat_section(SLNo, SectId, aId,ComId,SectName, SectNameB,PCName, LUserId) ";
                    sqlQuery = sqlQuery + " Values ('" + txtSlNo.Text.ToString() + "'," + NewId + ", " + NewId + ", '" + Common.Classes.clsMain.intComId + "', '" + txtName.Text.ToString() + "', '" + txtNameB.Text.ToString() + "','" + Common.Classes.clsMain.strComputerName + "','" + Common.Classes.clsMain.intUserId + "' )";
        ...
        {
            if (
                MessageBox.Show("Do you want to delete Section information of [" + txtName.Text + "]", "",
            ...
            try
            {
                ...
                //Delete Data
                sqlQuery = "Delete from tblCat_section  Where SectId  = " + Int32.Parse(txtId.Text);
                arQuery.Add(sqlQuery);
        ...
        private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridList.DisplayLayout.Bands[0].Columns["SectNameB"].Header.Caption = "SectBName";
            //gridList.DisplayLayout.Bands[0].Columns["DeptName"].Header.Caption = "Department";
           
            //Set Width
            gridList.DisplayLayout.Bands[0].Columns["SectName"].Width = 170;
            gridList.DisplayLayout.Bands[0].Columns["SectNameB"].Width = 160;
            //gridList.DisplayLayout.Bands[0].Columns["DeptName"].Width = 165;
        ...
        private void txtNameB_ValueChanged(object sender, EventArgs e)
        {
