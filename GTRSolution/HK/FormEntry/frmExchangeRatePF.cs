...
{
    public partial class frmExchangeRatePF : Form
    {
        ...
        public frmExchangeRatePF(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab,
        ...
        private void frmExchangeRatePF_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void prcLoadList()
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetExchangeRatePF 0";
        ...
        public void prcDisplayDetails(string strParam)
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetExchangeRatePF " + Int32.Parse(strParam);
        ...
        private void frmExchangeRatePF_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Delete Data
                sqlQuery = "Delete From tblCat_ExchangeRatePF where ExchId =  " + Int32.Parse(txtId.Text);
                arQuery.Add(sqlQuery);
