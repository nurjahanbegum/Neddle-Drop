...
{
    public partial class frmGradeInsurance : Form
    {
        ...
        public frmGradeInsurance(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmGradeInsurance_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void prcLoadList()
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetGradeInsurance  '" + this.Tag.ToString() + "'";
        ...
        private void frmGradeInsurance_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridList.DisplayLayout.Bands[0].Columns["Amount"].Width = 300;
        ...
        public Boolean fncBlank(string tbl, int Rowno)
        {
            ...
            {
                dsList.Tables[tbl].Rows[Rowno][5] = 0;
            }
                ...
                for (rowCount = 0; rowCount < dsList.Tables["Varible"].Rows.Count; rowCount++)
                {
                        ...
                        dsList.Tables["Varible"].Rows[rowCount]["Flag"].ToString() == "1")
                    {
                        ...
                        sqlQuery = "Update tblCat_Variable Set varName = '" + dsList.Tables["Varible"].Rows[rowCount][1] +
                                   "', varType = '" + dsList.Tables["Varible"].Rows[rowCount][2] + "', Amount = '" +
                                   dsList.Tables["Varible"].Rows[rowCount][3] + "', aId = '" +
                                   dsList.Tables["Varible"].Rows[rowCount][4] + "', isInactive = '" +
                    ...
                    {
                        // Insert To Table
                        sqlQuery = "Insert into tblCat_Variable(varName, varType, Amount, aId, isInactive) values('" +
