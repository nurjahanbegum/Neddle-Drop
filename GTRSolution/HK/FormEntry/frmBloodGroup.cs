...
namespace GTRHRIS.HK.FormEntry
{
    public partial class frmBloodGroup : Form
    {
        ...
        public frmBloodGroup(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmBloodGroup_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void gridList_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            ...
            gridList.DisplayLayout.Bands[0].Columns["aId"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.IntegerWithSpin;
