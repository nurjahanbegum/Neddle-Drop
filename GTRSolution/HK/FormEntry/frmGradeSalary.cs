...
{
    public partial class frmGradeSalary : Form
    {
        ...
        public frmGradeSalary(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmGradeSalary_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        public void prcLoadList()
        {
            ...
            try
            {
                string SqlQuery = "Exec prcGetGradeSalary  '" + this.Tag.ToString() + "'";
        ...
        private void frmGradeSalary_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridList.DisplayLayout.Bands[0].Columns["GSMin"].Header.Caption = "Minimum Gross";
            gridList.DisplayLayout.Bands[0].Columns["Remarks"].Header.Caption = "Remarks";

            //Set Width
            gridList.DisplayLayout.Bands[0].Columns["Grade"].Width = 120;
            gridList.DisplayLayout.Bands[0].Columns["GSMin"].Width = 140;
            gridList.DisplayLayout.Bands[0].Columns["Remarks"].Width = 485;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (rowCount = 0; rowCount < dsList.Tables["Varible"].Rows.Count; rowCount++)
                {
                    ...
                    {
                        //Update Table
                        sqlQuery = "Update tblCat_Grade Set Grade = '" + dsList.Tables["Varible"].Rows[rowCount][1] +
                                   "', GSMin = '" + dsList.Tables["Varible"].Rows[rowCount][2] + "', Remarks = '" +
                                   dsList.Tables["Varible"].Rows[rowCount][3] + "' where Id = '" +
                    ...
                    {
                        // Insert To Table
                        sqlQuery = "Insert into tblCat_Grade(Grade, GSMin, Remarks) values('" +
                                   dsList.Tables["Varible"].Rows[rowCount][1] + "','" + dsList.Tables["Varible"].Rows[rowCount][2] + "','" +
        ...
        {
            gridList.ActiveRow.Cells[4].Value = 1;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Delete Data
                sqlQuery = "Delete From tblCat_Grade where Id = " + Int32.Parse(gridList.ActiveRow.Cells[0].Value.ToString());
                arQuery.Add(sqlQuery);
