...
{
    public partial class frmBandSubIncen : Form
    {
        ...
        public frmBandSubIncen(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmBandSubIncen_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmBandSubIncen_Load(object sender, EventArgs e)
        {
            try
            {
