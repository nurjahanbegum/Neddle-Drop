...
{
    public partial class frmrptSuspendLetter : Form
    {
        ...
        public frmrptSuspendLetter(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptLetterSuspend " + Common.Classes.clsMain.intComId;
