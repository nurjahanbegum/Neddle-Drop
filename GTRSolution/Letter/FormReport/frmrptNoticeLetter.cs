...
{
    public partial class frmrptNoticeLetter : Form
    {
        ...
        public frmrptNoticeLetter(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptLetterNotice " + Common.Classes.clsMain.intComId;
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Inquiry")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptNoticeInquiry.rdlc";
                    SQLQuery = "Exec rptLetterNotice " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                ...
                else if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Showcause")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptNoticeShowcause.rdlc";
                    SQLQuery = "Exec rptLetterNotice " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                }

                else if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Damage")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptNoticeDamage.rdlc";
                    SQLQuery = "Exec rptLetterNotice " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                }
