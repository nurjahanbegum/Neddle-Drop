...
{
    public partial class frmrptWarningLetter : Form
    {
        ...
        public frmrptWarningLetter(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptLetterWarning " + Common.Classes.clsMain.intComId;
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Late")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptWarningLate.rdlc";
                    SQLQuery = "Exec rptLetterWarning " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                ...
                else if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Behavior")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptWarningBehavior.rdlc";
                    SQLQuery = "Exec rptLetterWarning " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                    //ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Confirmation.docx";
                    //SQLQuery = "Exec rptLetterAll " + Common.Classes.clsMain.intComId + ", '" + Criteria + "', '" + Status + "','" +
                    //           clsProc.GTRDate(dtFrom.Value.ToString()) + "', '" +
                    //           clsProc.GTRDate(dtTo.Value.ToString()) + "', '" + type + "'," + SectId + ", " + EmpId +" ";
                }

                else if (gridIncrType.ActiveRow.Cells["CValue"].Text.ToString() == "Negligence")
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Letter\Reports\rptWarningNegligence.rdlc";
                    SQLQuery = "Exec rptLetterWarning " + Common.Classes.clsMain.intComId + "," + SectId + ", " + EmpId + ",'" + Lettertype + "' ";
                }
                ...
                string FormCaption = "Report :: Warning Letter...";
