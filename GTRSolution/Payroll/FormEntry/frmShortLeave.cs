...
namespace GTRHRIS.Payroll.FormEntry
{
    public partial class frmShortLeave : Form
    {
        ...
        public frmShortLeave(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void gridList_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            try
            {
                ...
                gridList.DisplayLayout.Bands[0].Columns["SrtId"].Hidden = true;  //SrtId
                ...
                //Set Width
                gridList.DisplayLayout.Bands[0].Columns["EmpCode"].Width = 110;  //Short Name
                gridList.DisplayLayout.Bands[0].Columns["empName"].Width = 130;  //Country Name
                gridList.DisplayLayout.Bands[0].Columns["dtJoin"].Width = 120;  //Country Name
                gridList.DisplayLayout.Bands[0].Columns["SectName"].Width = 120;  //Country Name
                gridList.DisplayLayout.Bands[0].Columns["DesigName"].Width = 150;  //Country Name
                ...
                gridList.DisplayLayout.Bands[0].Columns["SrtHr"].Header.Caption = "Hour"; 
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetShortLeave] 0," + Common.Classes.clsMain.intComId + ",0,'" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
        ...
        private void frmSalAdv_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
        ...
        private void frmSalAdv_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            if (MessageBox.Show("Do you want to delete short leave hour  [" + txtName.Text + "] this Employee" , "", System.Windows.Forms.MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.No)
            {
                return;
            }
            ...
            {
                string sqlQuery = "";
                sqlQuery = "Delete from tblEmp_ShortLeave Where SrtId = " + Int32.Parse(txtId.Text);
                arQuery.Add(sqlQuery);
        ...
        private void prcDisplayDetails(string strParam)
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetShortLeave] " + Int32.Parse(strParam) + "," + Common.Classes.clsMain.intComId + ",0,'" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
                ...
                if (dsDetails.Tables["tblSalAdv"].Rows.Count > 0)
                {
                    ...
                    this.txtId.Text = dr["SrtId"].ToString();
                    ...
                    this.txtHr.Text = dr["SrtHr"].ToString();
        ...
        private void gridList_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                prcClearData();
                prcDisplayDetails(gridList.ActiveRow.Cells["SrtId"].Value.ToString());
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetShortLeave] 0," + Common.Classes.clsMain.intComId + ",1,'" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
                clsCon.GTRFillDatasetWithSQLCommand(ref dsList, sqlQuery);
                dsList.Tables[0].TableName = "tblEmployee";
                //dsList.Tables[1].TableName = "tblEmployeeID";
