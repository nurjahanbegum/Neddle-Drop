        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (btnSave.Text.ToString() == "&Save")
                {
                    ...
                    sqlQuery = "Exec prcProcessAllowance " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDate.Value.ToString()) + "', 'Transport','" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
                    arQuery.Add(sqlQuery);
