...
{
    public partial class frmSalAdv : Form
    {
        ...
        public frmSalAdv(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void gridList_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            try
            {
                ...
                //								
                gridList.DisplayLayout.Bands[0].Columns["advID"].Hidden = true;  //advID
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec prcGetSalAdv 0," + Common.Classes.clsMain.intComId + ",0,'" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
        ...
        private void prcDisplayDetails(string strParam)
        {
            ...
            try
            {
                string sqlQuery = "Exec prcGetSalAdv " + Int32.Parse(strParam) + "," + Common.Classes.clsMain.intComId + ",0,'" + clsProc.GTRDate(dtDate.Value.ToString()) + "'";
                ...
                if (dsDetails.Tables["tblSalAdv"].Rows.Count > 0)
                {
                    ...
                    this.txtId.Text = dr["advID"].ToString();
        ...
        private void gridList_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                prcClearData();
                prcDisplayDetails(gridList.ActiveRow.Cells["advID"].Value.ToString());
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
