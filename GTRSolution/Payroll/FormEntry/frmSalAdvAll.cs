...
{
    public partial class frmSalAdvAll : Form
    {
        ...
        public frmSalAdvAll(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmSalAdvAll_Load(object sender, EventArgs e)
        {
        ...
        private void frmSalAdvAll_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void gridDetails_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            try
            {
                ...
                gridDetails.DisplayLayout.Bands[0].Columns["Amount"].Header.Caption = "Advance Amount";
        ...
        private void prcGetBasedLoad()
        {
            ...
            try
            {
                sqlQuery = "Exec prcGetSalAdvAll " + Common.Classes.clsMain.intComId + ", " + EmpId + "," + SectId + ",'" + Band + "','" + optCriteria.Value.ToString() + "','" + clsProc.GTRDate(dtFrom.Value.ToString()) + "'";
                clsCon.GTRFillDatasetWithSQLCommand(ref dsList, sqlQuery);
                dsList.Tables[0].TableName = "Grid";
