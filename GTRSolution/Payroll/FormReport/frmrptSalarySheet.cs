...
{
    public partial class frmrptSalarySheet : Form
    {
        ...
        public frmrptSalarySheet(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptSalarySheet " + Common.Classes.clsMain.intComId + "";
            ...
            try
            {
             ...
             //   EmpStatus = cboStatus.ActiveRow.Cells["EmpStatus"].Value.ToString();
                ...
                if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
                {
                    ...
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySheetReleased.rdlc";
                        SQLQuery = "Exec [rptSalarySheetReleased] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                    else
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySheet.rdlc";
                        SQLQuery = "Exec [rptSalarySheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                }
                ...
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptPayslip.rdlc";
                    SQLQuery = "Exec [rptSalarySheetPaySlip] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                }
                ...
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySum.rdlc";
                    SQLQuery = "Exec [rptSalarySum] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                }
                ...
                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Holiday Bill Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryHolidayBill.rdlc";
                    SQLQuery = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Holiday Bill Sheet'";
                }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Salary Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Summary Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Arrear Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Advance Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Deduction Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Loan Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','PF Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Denomination'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Bank Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
