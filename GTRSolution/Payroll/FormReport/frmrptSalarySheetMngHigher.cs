...
{
    public partial class frmrptSalarySheetMngHigher : Form
    {
        ...
        public frmrptSalarySheetMngHigher(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptSalarySheet " + Common.Classes.clsMain.intComId + ", 'Management'";
        ...
        private void frmrptSalarySheetMngHigher_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void frmrptSalarySheetMngHigher_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Final Settlement"))
                {
                    ...
                    SQLQuery = "Exec [rptSalarySheetMng] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "',1";
                }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
              ...
              {
                  string sqlquary = "Exec [rptSalarySheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Addition Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
