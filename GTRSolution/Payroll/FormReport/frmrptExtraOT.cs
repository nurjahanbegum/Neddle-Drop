...
{
    public partial class frmrptExtraOT : Form
    {
        ...
        public frmrptExtraOT(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptSalarySheetEOT " + Common.Classes.clsMain.intComId + "";
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string ReportPath = "", SQLQuery = "", DataSourceName = "DataSet1", FormCaption = "",  Band = "=All=";
                ...
                if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
                {
                    ...
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptEOTSheet.rdlc";
                        SQLQuery = "Exec [rptSalarySheetEOTAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                    else if (cboStatus.Text == "Released")
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptEOTSheet.rdlc";
                        SQLQuery = "Exec [rptSalarySheetEOTReleased] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                    else
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptEOTSheet.rdlc";
                        SQLQuery = "Exec [rptSalarySheetEOT] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                }
                ...
                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Summary Sheet"))
                {
                    if (cboStatus.Text == "=ALL=")
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptEOTSum.rdlc";
                        SQLQuery = "Exec [rptSalarySumALL] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
              ...
              if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
              {
                  string sqlquary = "Exec [rptSalarySheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalarySheetPaySlip] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryDataCheckList] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalarySum] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalarySumDenomination] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Other Allowance Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Addition Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Production Bonus'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Loan Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Advance Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Income Tax'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','PF Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalaryAll] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Deduction Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalarySheetCadre] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Bank Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptSalarySheetCadre] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + cboStatus.Value.ToString() + "','Cadre Sheet'";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
