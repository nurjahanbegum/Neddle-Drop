...
{
    public partial class frmrptSalarySheetB2 : Form
    {
        ...
        public frmrptSalarySheetB2(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptSalarySheetB2 " + Common.Classes.clsMain.intComId + "";
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
                {
                    ...
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySheetB2.rdlc";
                        SQLQuery = "Exec [rptSalarySheetB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                    else if (cboStatus.Text == "Released")
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySheetB2.rdlc";
                        SQLQuery = "Exec [rptSalarySheetReleasedB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
                    else
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySheetB2.rdlc";
                ...
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptPayslipB2.rdlc";
                    SQLQuery = "Exec [rptSalarySheetPaySlipB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                }
                ...
                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Summary Sheet"))
                {
                    if (cboStatus.Text == "=ALL=")
                    {
                        ...
                        SQLQuery = "Exec [rptSalarySumB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "'";
                    }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Salary Sheet"))
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Salary Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Summary Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Arrear Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Advance Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Deduction Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Loan Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','PF Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Denomination'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            {
                string sqlquary = "Exec [rptSalarySheetExcelB2] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','" + Band + "','" + cboStatus.Value.ToString() + "','Bank Sheet'";
                clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
