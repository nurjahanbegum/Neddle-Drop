...
{
    public partial class frmrptFestBonus : Form
    {
        ...
        public frmrptFestBonus(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptFestBonus " + Common.Classes.clsMain.intComId + ", 'Admin'";
        ...
        private void frmrptFestBonus_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void frmrptFestBonus_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FormCaption = "Report :: Festival Sheet";

                //Festival Bonus Sheet

                if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Bonus Sheet"))
                    {

                          ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptFestivalBonusSheet.rdlc";
                          SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',1";
             
                    }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Payslip"))
                    {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptPaySlipFestival.rdlc";
                        SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',2";
                    }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Summary Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptFestSum.rdlc";
                    SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',3";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Denomination"))
                   {
                        ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySumDenomination.rdlc";
                        SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',4";
                   }


                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Bank Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryBankACC.rdlc";
                    SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',5";

                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Cadre Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryCadre.rdlc";
                    SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',6";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Band Cadre Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryCadreBand.rdlc";
                    SQLQuery = "Exec [rptFestBonus] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',7";
                }


               //Advance Salary Sheet

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Salary Sheet"))
                {

                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptFestAdvanceSheet.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',1";

                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Payslip"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptPaySlipFestival.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',2";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Summary Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptFestSumAdv.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',3";
                }


                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Denomination"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalarySumDenomination.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',4";
                }


                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Bank Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryBankACC.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',5";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Cadre Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryCadre.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',9";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Band Cadre Sheet"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Payroll\Reports\rptSalaryCadreBand.rdlc";
                    SQLQuery = "Exec [rptFestAdvanceSheet] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',10";
                }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
              ...
              if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Festival Bonus Sheet"))
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',1";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',3";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',4";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',5";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',6";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestBonusExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',7";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
             ...
             //Advance Salary Sheet
              ...
              else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Advance Salary Sheet"))
              {
                  ...
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',1";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',3";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "', '" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',4";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',5";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',9";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
              ...
              {
                  string sqlquary = "Exec [rptFestAdvanceSheetExcel] " + Common.Classes.clsMain.intComId + ", '" + gridProssType.ActiveRow.Cells[0].Value.ToString() + "','" + cboPayMode.Value.ToString() + "', '" + cboEmpType.Value.ToString() + "','" + gridSec.ActiveRow.Cells[0].Value.ToString() + "','" + gridEmployee.ActiveRow.Cells[0].Value.ToString() + "','','" + cboStatus.Value.ToString() + "',10";
                  clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
