...
{
    public partial class frmEmpInc : Form
    {
        private string X = " ";
        ...
        public frmEmpInc(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmEmpInc_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmEmpInc_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetIncrement] " + Common.Classes.clsMain.intComId + ", 0,0";
        ...
        private void prcLoadCombo()
        {
            ...
            cboNewGrade.DataSource = null;
            cboNewGrade.DataSource = dsList.Tables["tblGrade"];
            cboNewGrade.DisplayMember = "Grade";
            cboNewGrade.ValueMember = "Grade";

            cboOldGrade.DataSource = null;
            cboOldGrade.DataSource = dsList.Tables["tblGrade"];
            cboOldGrade.DisplayMember = "Grade";
            cboOldGrade.ValueMember = "Grade";
        ...
        private void prcDisplayDetails(string strParam)
        {
            ...
            try
            {
                string sqlQuery = "Exec prcGetIncrement " + Common.Classes.clsMain.intComId + " , " +Int32.Parse(strParam) + ",0 ";
                ...
                if (dsDetails.Tables["Details"].Rows.Count > 0)
                {
                    ...
                    this.txtTA.Text = dr["PBns"].ToString();

                    this.txtPrevGS.Text = "0";
                    this.txtPrevBS.Text = "0";
                    this.txtPrevHR.Text = "0";
                    this.txtPrevMA.Text = "0";
                    this.cboNewGrade.Text = dr["NewGrade"].ToString();
                    this.cboOldGrade.Text = dr["OldGrade"].ToString();
        ...
        private void prcClearData()
        {
            ...
            txtPrevGSUSD.Value = 0;
            txtNewGSUSD.Value = 0;
            txtIncAmountUSD.Value = 0;
            ...
            txtPrevSalUSD.Value = 0;
            txtPrevGS.Value = 0;
            txtPrevBS.Value = 0;
            txtPrevHR.Value = 0;
            txtPrevMA.Value = 0;
            cboNewGrade.Value = null;
            cboOldGrade.Value = null;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cboNewGrade.Text.Length == 0)
                {
                    cboNewGrade.Value = 0;
                }

                if (cboOldGrade.Text.Length == 0)
                {
                    cboOldGrade.Value = 0;
                }
                ...
                if (btnSave.Text != "&Save")
                {
                    ...
                    {
                        //Update
                        sqlQuery = "Update tblEmp_Incr Set  IncType = '" + cboType.Text + "', dtInc = '" + clsProc.GTRDate(dtIncDate.Value.ToString()) + "',AmountGSD = '" + txtIncAmountUSD.Text + "', Amount = '" + txtIncAmount.Text +
                                   "', Percentage = '" + clsProc.GTRValidateDouble(txtPer.Text.ToString()) + "',OldSalUSD = " + clsProc.GTRValidateDouble(txtPrevGSUSD.Text.ToString()) + ", OldSal =  " + clsProc.GTRValidateDouble(txtPrevSalary.Text.ToString()) + ", NewSal = " + clsProc.GTRValidateDouble(txtNewSal.Text.ToString()) +
                                   ",NewSalUSD = " + clsProc.GTRValidateDouble(txtNewGSUSD.Text.ToString()) + ", OldDesigId =" + cboPrevDesig.Value.ToString() + ", NewDesigId = " + cboNewDesig.Value.ToString() + ", BS = " + clsProc.GTRValidateDouble(txtBS.Text.ToString()) + ",HR =" + clsProc.GTRValidateDouble(txtHR.Value.ToString()) +
                                   ", MA = " + clsProc.GTRValidateDouble(txtMA.Value.ToString()) + ", OldSectId = '" + cboSection.Value.ToString() + "', NewSectId = " + cboNewSection.Value +
                                   ",OldStatus = '" + cboPrevStatus.Value.ToString()
                                   + "', NewStatus =  '" + cboNewStatus.Value.ToString()
                                   + "',OldGrade = '" + cboOldGrade.Value.ToString()
                                   + "', NewGrade =  '" + cboNewGrade.Value.ToString() +
                        ...
                        sqlQuery = "Update tblemp_Info Set  DesigID = '" + cboNewDesig.Value.ToString() + "',SectID = '" + cboNewSection.Value.ToString() + "',Grade ='" + (cboNewGrade.Text.ToString()) + "',EmpType ='" + (cboNewStatus.Text.ToString()) + "'  WHERE empid = '" + this.cboEmpID.Value.ToString() + "'";
                        arQuery.Add(sqlQuery);
                        ...
                        sqlQuery = "Update tblemp_Info Set  TS = '" + txtNewSal.Text.ToString() + "',GSUSD = '" + txtNewGSUSD.Text.ToString() + "', GS = '" + txtNewSal.Text.ToString() 
                                   + "',BS = " + clsProc.GTRValidateDouble(txtBS.Text.ToString()) 
                                   + ", HR =" + clsProc.GTRValidateDouble(txtHR.Value.ToString()) 
                                   + ", MA = " + clsProc.GTRValidateDouble(txtMA.Value.ToString()) + ",dtIncrement = '" + clsProc.GTRDate(dtIncDate.Value.ToString()) 
                    ...
                    else if (cboType.Text == "Promotion")
                    {
                        ...
                        sqlQuery = "Update tblEmp_Incr Set  IncType = '" + cboType.Text + "', dtInc = '" + clsProc.GTRDate(dtIncDate.Value.ToString()) + "', Amount = '" + txtIncAmount.Text +
                                   ...
                                   ", OldDesigId =" + cboPrevDesig.Value.ToString() + ", NewDesigId = " + cboNewDesig.Value.ToString() + ", BS = " + clsProc.GTRValidateDouble(txtBS.Text.ToString()) + ",HR =" + clsProc.GTRValidateDouble(txtHR.Value.ToString()) +
                                   ", MA = " + clsProc.GTRValidateDouble(txtMA.Value.ToString()) + ", OldSectId = '" + cboSection.Value.ToString() + "', NewSectId = " + cboNewSection.Value +
                                   ",OldStatus = '" + cboPrevStatus.Value.ToString()
                                   + "', NewStatus =  '" + cboNewStatus.Value.ToString()
                                   +"',OldGrade = '" + cboOldGrade.Value.ToString()
                        ...
                        //sqlQuery = "Update tblemp_Info Set  TS = '" + txtNewSal.Text.ToString() + "', GS = '" + txtNewSal.Text.ToString() + "' WHERE empid = '" + this.cboEmpID.Value.ToString() + "'";
                        //arQuery.Add(sqlQuery);
                    ...
                    else if (cboType.Text == "Confirmation")
                    {
                        ...
                        else
                        {
                            ...
                            //Update
                            sqlQuery = "Update tblEmp_Incr Set  IncType = '" + cboType.Text + "', dtInc = '" + clsProc.GTRDate(dtIncDate.Value.ToString()) + "',AmountGSD = '" + txtIncAmountUSD.Text + "', Amount = '" + txtIncAmount.Text +
                                       "', Percentage = '" + clsProc.GTRValidateDouble(txtPer.Text.ToString()) + "',OldSalUSD = " + clsProc.GTRValidateDouble(txtPrevGSUSD.Text.ToString()) + ", OldSal =  " + clsProc.GTRValidateDouble(txtPrevSalary.Text.ToString()) + ",NewSalUSD = " + clsProc.GTRValidateDouble(txtNewGSUSD.Text.ToString()) + ", NewSal = " + clsProc.GTRValidateDouble(txtNewSal.Text.ToString()) +
                                       ", OldDesigId =" + cboPrevDesig.Value.ToString() + ", NewDesigId = " + cboNewDesig.Value.ToString() + ", BS = " + clsProc.GTRValidateDouble(txtBS.Text.ToString()) + ",HR =" + clsProc.GTRValidateDouble(txtHR.Value.ToString()) +
                                       ", MA = " + clsProc.GTRValidateDouble(txtMA.Value.ToString()) + ", OldSectId = '" + cboSection.Value.ToString() + "', NewSectId = " + cboNewSection.Value +
                                       ",OldStatus = '" + cboPrevStatus.Value.ToString()
                                       + "', NewStatus =  '" + cboNewStatus.Value.ToString() +
                ...
                else
                {
                    ...
                    if (cboType.Text == "Increment with Promotion")
                    {
                        ...
                        //Insert Data
                        sqlQuery = "INSERT into dbo.tblEmp_Incr(IncId, IncType, EmpId, dtInc,AmountUSD, Amount, Percentage,OldSalUSD, OldSal, NewSalUSD,NewSal, OldDesigId, NewDesigId, BS,HR,MA,TA, OldSectId, NewSectId,,OldGrade, NewGrade,OldStatus, NewStatus,IsInactive, ComId, LUserId, PCName)"
                                   + " Values (" + NewId + ", '" + cboType.Text + "','" + this.cboEmpID.Value.ToString() + "','" + clsProc.GTRDate(dtIncDate.Value.ToString()) + "','" + txtIncAmountUSD.Text + "','" + txtIncAmount.Text + "','" + txtPer.Text + "'," + clsProc.GTRValidateDouble(txtPrevGSUSD.Text.ToString()) + ", '" + txtPrevSalary.Text + "'," + clsProc.GTRValidateDouble(txtNewGSUSD.Text.ToString()) + ",'" +
                                   txtNewSal.Text.ToString() + "', " + cboPrevDesig.Value.ToString() + ",'" + cboNewDesig.Value.ToString() + "', '" + clsProc.GTRValidateDouble(txtBS.Text.ToString()) + "','" + clsProc.GTRValidateDouble(txtHR.Value.ToString()) + "','" + clsProc.GTRValidateDouble(txtMA.Value.ToString()) + "','" +
                                   clsProc.GTRValidateDouble(txtTA.Text.ToString()) + "', '" + cboSection.Value.ToString() + "', '" + cboNewSection.Value.ToString() + "', '" +
                                   (cboOldGrade.Text.ToString()) + "','" + (cboNewGrade.Text.ToString()) + "','" +
        ...
        private void gridList_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            try
            {
                ...
                gridList.DisplayLayout.Bands[0].Columns["OldGrade"].Header.Caption = "Old Grade";
                gridList.DisplayLayout.Bands[0].Columns["Grade"].Header.Caption = "New Grade";
            ...
            try
            {
                if (cboEmpID.Value != null)
                {
                    ...
                    if (ActiveSalary == 1)
                    {
                        ...
                        txtPrevGSUSD.Text = cboEmpID.ActiveRow.Cells["GSUSD"].Value.ToString();
                        txtPrevSalary.Text = cboEmpID.ActiveRow.Cells["Gs"].Value.ToString();
                        txtPrevSalUSD.Text = cboEmpID.ActiveRow.Cells["GSUSD"].Value.ToString();
                        txtPrevGS.Text = cboEmpID.ActiveRow.Cells["GS"].Value.ToString();
                        txtPrevBS.Text = cboEmpID.ActiveRow.Cells["BS"].Value.ToString();
                        txtPrevHR.Text = cboEmpID.ActiveRow.Cells["HR"].Value.ToString();
                        txtPrevMA.Text = cboEmpID.ActiveRow.Cells["MA"].Value.ToString();
                        ...
                        cboNewGrade.Text = cboEmpID.ActiveRow.Cells["Grade"].Value.ToString();
                        cboOldGrade.Text = cboEmpID.ActiveRow.Cells["Grade"].Value.ToString();


                        string sqlQuery = "Exec [prcGetIncrement] " + Common.Classes.clsMain.intComId + ", '" + cboEmpID.Value.ToString() + "','" + cboEmpID.Value.ToString() + "'";
                        clsCon.GTRFillDatasetWithSQLCommand(ref dsList, sqlQuery);
                    ...
                    {
                        MessageBox.Show("You have no permission to access this Employee ID.Please communicate to Administrator.");
                        return;
                    }
        ...
        private void txtAmt_ValueChanged(object sender, EventArgs e)
        {
            if (cboType.Text == "Increment")
            {
                ...
                if (double.Parse(txtAmt.Value.ToString()) > 0)
                {
                    ...
                    if (cboPrevStatus.Text == "Worker")
                    {
                        txtNewSal.Value =
                           Math.Round(double.Parse(txtPrevSalary.Value.ToString()) +
                                      double.Parse(txtAmt.Value.ToString()));
                        txtBS.Value = Math.Round(((double.Parse(txtNewSal.Value.ToString()) - 1850) / 1.5));
                        txtMA.Value = 600;
                        txtHR.Value =
                            Math.Round(double.Parse(txtNewSal.Value.ToString()) -
                                       (double.Parse(txtBS.Value.ToString()) + 1850)); //+ double.Parse(txtMA.Value.ToString())));

                        txtNewGSUSD.Value = Math.Round((double.Parse(txtNewSal.Value.ToString()) / 80.0), 2);
                        txtIncAmount.Value = (double.Parse(txtNewSal.Value.ToString()) -
                                              double.Parse(txtPrevSalary.Value.ToString()));
                        txtIncAmountUSD.Value = Math.Round((double.Parse(txtIncAmount.Value.ToString()) / 80.0), 2);

                        txtPer.Value =
                            Math.Round((double.Parse(txtIncAmount.Value.ToString())) * 100 /
                                       (double.Parse(txtPrevSalary.Value.ToString())));
                    }
                    else
                    {
                        txtNewSal.Value =
                            Math.Round(double.Parse(txtPrevSalary.Value.ToString()) +
                                       double.Parse(txtAmt.Value.ToString()));
                        txtBS.Value = Math.Round(((double.Parse(txtNewSal.Value.ToString()) - 1100) / 1.4));
                        txtMA.Value = 250;
                        txtHR.Value =
                            Math.Round(double.Parse(txtNewSal.Value.ToString()) -
                                       (double.Parse(txtBS.Value.ToString()) + 1100)); //+ double.Parse(txtMA.Value.ToString())));
