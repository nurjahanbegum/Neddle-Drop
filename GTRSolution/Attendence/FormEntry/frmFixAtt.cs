...
{
    public partial class frmFixAtt : Form
    {
        ...
        public frmFixAtt(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetFixAtt] 0," + Common.Classes.clsMain.intComId + ",'" + optCriteria.Value +
        ...
        private void frmFixAtt_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
                ...
                else
                {
                    foreach (Infragistics.Win.UltraWinGrid.UltraGridRow row in this.gridList.Rows)
                    {
                            ...
                            row.Cells["isChecked"].Value.ToString() == "1")
                        {
                            ...
                            sqlQuery = " Insert Into tblAttfixed(empid,dtPunchDate,TimeIn,TimeOut,OT,Status,Remarks,ShiftID,TimeInPrev,TimeOutPrev,OTHrPrev,StatusPrev,Luserid,comid,pcname) "
                            ...
                            string sqlQuery2 = "Exec [prcProcessAttendFix] " + Common.Classes.clsMain.intComId + ",'" + row.Cells["dtPunchDate"].Text.ToString() + "','" + row.Cells["dtPunchDate"].Text.ToString() + "','" + row.Cells["empid"].Text.ToString() + "'";
                            ...
                            //}
                            string sqlQuery3 = "Exec [prcProcessAttendFixB] " + Common.Classes.clsMain.intComId + ",'" + row.Cells["dtPunchDate"].Text.ToString() + "','" + row.Cells["dtPunchDate"].Text.ToString() + "','" + row.Cells["empid"].Text.ToString() + "'";
        ...
        private void frmFixAtt_FormClosing(object sender, FormClosingEventArgs e)
        {
