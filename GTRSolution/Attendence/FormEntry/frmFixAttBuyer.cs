...
{
    public partial class frmFixAttBuyer : Form
    {
        ...
        public frmFixAttBuyer(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmAttManual_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
        ...
        private void frmAttManual_FormClosing(object sender, FormClosingEventArgs e)
        {
