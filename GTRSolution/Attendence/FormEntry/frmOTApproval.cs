...
{
    public partial class frmOTApproval : Form
    {
        ...
        public frmOTApproval(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void gridList_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            try
            {
                ...
                gridList.DisplayLayout.Bands[0].Columns["empName"].Width = 200; //Country Name
                gridList.DisplayLayout.Bands[0].Columns["SectName"].Width = 180;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetOTApproval] 0," + Common.Classes.clsMain.intComId + ",'" + optCriteria.Value +
        ...
        private void frmOTApproval_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
        ...
        private void frmOTApproval_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private Boolean fncBlank()
        {
            ...
            else if (optCriteria.Value == "DeptID")
            {
                if (this.cboDept.Text.Length == 0)
                {
                    MessageBox.Show("Please provide Department");
