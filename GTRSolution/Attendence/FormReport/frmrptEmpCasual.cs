...
{
    public partial class frmrptEmpCasual : Form
    {
        ...
        public frmrptEmpCasual(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
