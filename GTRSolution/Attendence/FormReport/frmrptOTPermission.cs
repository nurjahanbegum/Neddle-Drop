...
{
    public partial class frmrptOTPermission : Form
    {
        ...
        public frmrptOTPermission(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                rptQuery = "Exec rptOTPermission " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", '', '', " + EmpId + "";
        ...
        private void frmrptOTPermission_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmrptOTPermission_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptOTPermission.rdlc";
            prcShowReport();
        }
