...
{
    public partial class frmrptLeaveAbsent : Form
    {
        ...
        public frmrptLeaveAbsent(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                rptQuery = "Exec rptLeaveAbsent " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", '', '', " + EmpId + "";
        ...
        private void frmrptLeaveAbsent_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmrptLeaveAbsent_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptLeaveAbsent.rdlc";
            prcShowReport();
        }
