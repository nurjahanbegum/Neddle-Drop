...
{
    public partial class frmrptJobCard : Form
    {
        string strTranWith = "";
        ...
        public frmrptJobCard(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void btnPrevew_Click(object sender, EventArgs e)
        {
            ...
            if (optrptFormat.Value.ToString().ToUpper() == "General".ToUpper())
            {
                ...
                if (optCriteria.Value.ToString().ToUpper() == "Department".ToUpper())
                {
                    ...
                    SQLQuery = "Exec rptJobCard " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "'," + DeptId.ToString() + ", '" + strFloor + "','" + Band + "', " + EmpId + " ";
                ...
                else if (optCriteria.Value.ToString().ToUpper() == "Employee".ToUpper())
                {
                    ...
                    foreach (Infragistics.Win.UltraWinGrid.UltraGridRow row in this.gridEmployee.Rows)
                    {
                            ...
                            row.Cells["isCheck"].Value.ToString() == "1")
                        {
                            ...
                            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptJobCard.rdlc";
                            SQLQuery = "Exec rptJobCard " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "'," + DeptId.ToString() + ", '','" + Band + "', " + EmpId + " ";
