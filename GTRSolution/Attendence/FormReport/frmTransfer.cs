...
namespace GTRHRIS.Attendence.FormReport
{
    public partial class frmTransfer : Form
    {
        ...
        public frmTransfer(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                rptQuery = "Exec rptEmpTransfer " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", " + EmpId + ",'" + Band + "'";
        ...
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptTransfer.rdlc";
            prcShowReport();
        }
