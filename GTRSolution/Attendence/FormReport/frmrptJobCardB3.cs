...
{
    public partial class frmrptJobCardB3 : Form
    {
        string strTranWith = "";
        ...
        public frmrptJobCardB3(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
