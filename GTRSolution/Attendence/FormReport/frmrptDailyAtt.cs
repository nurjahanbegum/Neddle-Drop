...
{
    public partial class frmrptDailyAtt : Form
    {
        ...
        public frmrptDailyAtt(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendMissing.rdlc";
        ...
        {
            if (optCriteria.Value.ToString() == "Section")
            {
                ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendSum.rdlc";
                prcShowReport("Summary","Section");
            }
            else
            {
                ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendSum.rdlc";
                prcShowReport("Summary","Band");
            }
        }

        private void btnSumTiffin_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendSumSec.rdlc";
            prcShowReport("Summary Sec");
        }

        private void btnOT_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendOvertime.rdlc";
        ...
        private void frmrptDailyAtt_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmrptDailyAtt_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void btnHolidayAllw_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendHolidayAllw.rdlc";
            prcShowReport("Holiday Allownce");
        }

        private void btnOvrNightAllw_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendOverNightAllw.rdlc";
            prcShowReport("Over Night Allownce");
        }

        private void btnAbsentD_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendNightAllw.rdlc";
            prcShowReport("Night Allownce");
        }

        private void btnTimeRange_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendPresent.rdlc";
            prcShowReport("TimeRange");
        }

        private void btnMisIn_Click(object sender, EventArgs e)
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptAttendAbsentPresent.rdlc";
            prcShowReport("PresentAbsent");
        }
