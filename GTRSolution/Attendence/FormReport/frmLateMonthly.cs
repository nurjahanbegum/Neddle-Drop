...
{
    public partial class frmLateMonthly : Form
    {
        ...
        public frmLateMonthly(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                string SectId = "0", EmpId = "0", Band = "=All=", EmpType = "=All=";
                ...
                rptQuery = "Exec rptAttendMonthlyLate " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", '', '', " + EmpId + ",'" + Band + "','" + EmpType + "',0";
        ...
        private void frmLateMonthly_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmLateMonthly_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
