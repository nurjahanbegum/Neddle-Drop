...
{
    public partial class frmAttenMonthlyB : Form
    {
        ...
        public frmAttenMonthlyB(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmAttenMonthlyB_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmAttenMonthlyB_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            String sqlquary = "Exec rptAttendMonthlyB " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", '', '', " + EmpId + ",'" + Band + "','" + EmpType + "'," + SubSectId + "";
            clscon.GTRFillDatasetWithSQLCommand(ref dsList, sqlquary);
            ...
            dlgSurveyExcel.FileName = "Monthly Attendance" + "_" + DateTime.Now.ToShortDateString().Replace(@"/", "_");
