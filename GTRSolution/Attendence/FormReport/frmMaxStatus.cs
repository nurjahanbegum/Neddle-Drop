...
{
    public partial class frmMaxStatus : Form
    {
        ...
        public frmMaxStatus(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec prcrptMaxStatus  " + Common.Classes.clsMain.intComId;
        ...
        private void gridSection_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridSection.DisplayLayout.Bands[0].Columns["SectName"].Width = 225;
        ...
        private void gridEmployeeID_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridEmployeeID.DisplayLayout.Bands[0].Columns["EmpName"].Width = 205;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                string Type = "", SectId = "0", EmpId = "0";
              //  if (gridType.ActiveRow.Cells["CValue"].Text == "Present")
                
                Type = gridType.ActiveRow.Cells["CValue"].Value.ToString();
                ...
                rptQuery = "Exec rptMaxStatus " + Common.Classes.clsMain.intComId + ",'"+Type+"', '" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + " ";
        ...
        private void frmMaxStatus_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmMaxStatus_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        {
            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptMaxPresent.rdlc";
            prcShowReport();
        }

        private void gridType_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            gridType.DisplayLayout.Bands[0].Columns["CValue"].Hidden = true;
            gridType.DisplayLayout.Bands[0].Columns["SlNo"].Hidden = true;
            gridType.DisplayLayout.Bands[0].Columns["Type"].Width = 165;
            gridType.DisplayLayout.Bands[0].Columns["Type"].Header.Caption = "Criteria";
