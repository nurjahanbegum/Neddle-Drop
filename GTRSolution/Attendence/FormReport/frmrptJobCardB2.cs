...
{
    public partial class frmrptJobCardB2 : Form
    {
        string strTranWith = "";
        ...
        public frmrptJobCardB2(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void btnPrevew_Click(object sender, EventArgs e)
        {
            ...
            if (optrptFormat.Value.ToString().ToUpper() == "General".ToUpper())
            {
                ...
                if (optCriteria.Value.ToString().ToUpper() == "Department".ToUpper())
                {
                    ...
                    SQLQuery = "Exec rptJobCardB2 " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "'," + DeptId.ToString() + ", '" + strFloor + "','" + Band + "', " + EmpId + " ";
                ...
                else if (optCriteria.Value.ToString().ToUpper() == "Employee".ToUpper())
                {
                    ...
                    foreach (Infragistics.Win.UltraWinGrid.UltraGridRow row in this.gridEmployee.Rows)
                    {
                            ...
                            row.Cells["isCheck"].Value.ToString() == "1")
                        {
                            ...
                            ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptJobCardB.rdlc";
                            SQLQuery = "Exec rptJobCardB2 " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "'," + DeptId.ToString() + ", '','" + Band + "', " + EmpId + " ";
                            clsCon.GTRFillDatasetWithSQLCommand(ref dsDetails, SQLQuery);
                            clsMain.strReportName = "Job Card";
                        }
                    }
