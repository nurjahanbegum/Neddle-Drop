...
{
    public partial class frmrptOutTime : Form
    {
        ...
        public frmrptOutTime(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcShowReport()
        {
            ...
            try
            {
                ...
                string SectId = "0", EmpId = "0", Band = "=All=";
                ...
                rptQuery = "Exec rptOutTime " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", " + EmpId + ",'" + txtFrom.Text.ToString() + "','" + txtTo.Text.ToString() + "'";
        ...
        private void frmrptOutTime_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmrptOutTime_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
