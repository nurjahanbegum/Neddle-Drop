...
{
    public partial class frmAbsentMonthly : Form
    {
        ...
        public frmAbsentMonthly(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                ...
                //dsList.Tables[1].TableName = "Designation";
        ...
        private void prcShowReport()
        {
            try
            {
                ...
                rptQuery = "Exec rptAttendMonthlyAbsent " + Common.Classes.clsMain.intComId + ",'" + clsProc.GTRDate(dtDateFrom.Value.ToString()) + "', '" + clsProc.GTRDate(dtDateTo.Value.ToString()) + "', " + SectId + ", '', '', " + EmpId + "";
        ...
        private void frmAbsentMonthly_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmAbsentMonthly_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            //clsMain.strReportName = "Monthly Absent";
            prcShowReport();
        }
