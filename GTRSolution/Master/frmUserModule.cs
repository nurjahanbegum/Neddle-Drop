...
namespace GTRHRIS.Master
{
    public partial class frmUserModule : Form
    {
        ...
        public frmUserModule(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void frmUserModule_Load(object sender, System.EventArgs e)
        {
            prcLoadList();
            prcLoadCombo("");
        }

        private void frmUserModule_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void gridTran_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            ...
            gridTran.DisplayLayout.Bands[0].Columns[2].Hidden = true;   //Module Name
            gridTran.DisplayLayout.Bands[0].Columns[3].Width = 350;     //Module Caption
            gridTran.DisplayLayout.Bands[0].Columns[4].Width = 50;     //Default
            gridTran.DisplayLayout.Bands[0].Columns[5].Width = 50;     //SortNo

            gridTran.DisplayLayout.Bands[0].Columns[0].Header.Caption = "Allow";
            gridTran.DisplayLayout.Bands[0].Columns[1].Header.Caption = "Module Id";
            gridTran.DisplayLayout.Bands[0].Columns[2].Header.Caption = "Module Name";
            gridTran.DisplayLayout.Bands[0].Columns[3].Header.Caption = "Module Caption";
            gridTran.DisplayLayout.Bands[0].Columns[4].Header.Caption = "Default";
            gridTran.DisplayLayout.Bands[0].Columns[5].Header.Caption = "SortNo";
            ...
            this.gridTran.DisplayLayout.Bands[0].Columns[4].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.CheckBox;
            this.gridTran.DisplayLayout.Bands[0].Columns[5].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.IntegerPositiveWithSpin;
        ...
        private void gridList_DoubleClick(object sender, EventArgs e)
        {
            ...
            string sqlQuery = "Exec prcGetPermission_ModuleUser " + (Int32.Parse(txtUserId.Text)) + ", 0";
        ...
        {
            if (MessageBox.Show("Do you want to delete module permission information for user : [" + txtUserId.Text +"]", "", System.Windows.Forms.MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.No)
            {
                return;
            }
