...
{
    public partial class frmRptExamMarkEdit : Form
    {
        string strValue = "";
        ...
        public frmRptExamMarkEdit(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlQuery = "Exec [prcGetMarkEdit] " + Common.Classes.clsMain.intComId + ", " + cboSesn.Value.ToString() + ", " + cboClass.Value.ToString() + ", " + cboSub.Value.ToString() + ", 0 ";
                ...
                dsList.Tables[5].TableName = "tblEmpId";
        ...
        private void frmRptExamMarkEdit_Load(object sender, EventArgs e)
        {
            try
            {
                prcClearData();
        ...
        private void frmRptExamMarkEdit_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void cboId_InitializeLayout(object sender, InitializeLayoutEventArgs e)
        {
            cboId.DisplayLayout.Bands[0].Columns["EMpId"].Hidden = true;
            cboId.DisplayLayout.Bands[0].Columns["EmpCode"].Width = 70;
            cboId.DisplayLayout.Bands[0].Columns["EmpName"].Width = 100;
            cboId.DisplayLayout.Bands[0].Columns["EmpCode"].Header.Caption = "Student Code";
            cboId.DisplayLayout.Bands[0].Columns["EmpName"].Header.Caption = "Name";

            cboId.DisplayMember = "EmpName";
            cboId.ValueMember = "EMpId";
        }
    }
}
