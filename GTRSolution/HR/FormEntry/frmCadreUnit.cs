...
{
    public partial class frmCadreUnit : Form
    {
        ...
        public frmCadreUnit(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec rptCadreSumUnit  " + Common.Classes.clsMain.intComId + ",'','',0,0";
                ...
                dsList.Tables[2].TableName = "Position";
        ...
        private void frmCadreUnit_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmCadreUnit_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
       ...
       private void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sqlQuery = "Exec rptCadreSumUnit " + Common.Classes.clsMain.intComId + ",'" + Description + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,1";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Summary"))
            {
                sqlquary = "Exec rptCadreSumUnit " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,2";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Status"))
            {
                sqlquary = "Exec rptCadreSumUnit " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,3";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Position wise Cadre List"))
            {
                sqlquary = "Exec rptCadreSumUnit " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "','" + cboPosition.Value.ToString() + "',4";
            }
