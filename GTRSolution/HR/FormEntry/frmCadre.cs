...
{
    public partial class frmCadre : Form
    {
        ...
        public frmCadre(ref Infragistics.Win.UltraWinTabControl.UltraTabControl utab, Common.FormEntry.frmMaster fm)
        {
            InitializeComponent();
            uTab = utab;
            FM = fm;
        ...
        private void prcLoadList()
        {
            ...
            try
            {
                string sqlquary = "Exec rptCadreSum  " + Common.Classes.clsMain.intComId + ",'','',0,0,0";
        ...
        private void frmCadre_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmCadre_Load(object sender, EventArgs e)
        {
            try
            {
                prcLoadList();
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptCadreSum.rdlc";
                    rptQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,2";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Status"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptCadreSumStatus.rdlc";
                    rptQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,3";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Summary Analysis"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptCadreSumAnalysis.rdlc";
                    rptQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,4";
                }

                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Summary with Absenteeism"))
                {
                    ReportPath = Common.Classes.clsMain.AppPath + @"\Attendence\Reports\rptCadreSumAbsent.rdlc";
                    rptQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,5";
                }
                ...
                else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Position wise Cadre List"))
                {
                    ...
                    rptQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "','" + cboComp.Value.ToString() + "','" + cboPosition.Value.ToString() + "',6";
                }
        ...
        private void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sqlQuery = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + Description + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,1";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Summary"))
            {
                sqlquary = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,2";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Status"))
            {
                sqlquary = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,3";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Summary Analysis"))
            {
                sqlquary = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,4";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Cadre Summary with Absenteeism"))
            {
                sqlquary = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "',0,0,5";
            }

            else if ((gridReportCategory.ActiveRow.Cells["rptname"].Text.ToString() == "Position wise Cadre List"))
            {
                sqlquary = "Exec rptCadreSum " + Common.Classes.clsMain.intComId + ",'" + ProssType + "','" + clsProc.GTRDate(dtPross.Value.ToString()) + "','" + cboComp.Value.ToString() + "','" + cboPosition.Value.ToString() + "',6";
            }
